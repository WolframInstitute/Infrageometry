...
DisplacementCommutator::usage = "DisplacementCommutator[g, d1, d2] is the exact group commutator of two bijective displacements. DisplacementCommutator[g, d1, d2, v] evaluates it at v.";
DisplacementBracket::usage = "DisplacementBracket[g, d1, d2] is the scale-dependent metric bracket candidate obtained by composing d1, d2 and their metric negatives. DisplacementBracket[g, d1, d2, v] evaluates it at v.";
