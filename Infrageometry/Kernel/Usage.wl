...
DisplacementInverse::usage = "DisplacementInverse[g, d] is the metric reflection of each step of d through its base point, the scale -1 case of DisplacementScale.";
...
DisplacementCommutator::usage = "DisplacementCommutator[g, d1, d2] is the group commutator of the flows, second order in the scale. DisplacementCommutator[g, d1, d2, v] evaluates it at the single vertex v.";
...
ContinuousDisplacementQ::usage = "ContinuousDisplacementQ[g, d, k] tests k-continuity of displacement d: across every edge of g some pair of targets is at distance at most k (default k = 1).";
