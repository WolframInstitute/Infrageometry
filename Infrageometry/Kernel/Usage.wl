...
InteriorGraph::usage = "InteriorGraph[g] strips the degree-boundary of g (deletes every edge both of whose endpoints have below-average degree) and returns the largest connected component, preserving the original vertex coordinates and their dimension.";
