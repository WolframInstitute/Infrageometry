...
AmbientGraphStyle::usage = "AmbientGraphStyle[name] is the Graph option list rendering a substrate as a faint backdrop, one of \"Default\", \"GrayFaint\", \"GrayOpaque\" or \"Gray\"; the tier names \"Small\" | \"Medium\" | \"Large\" are accepted as aliases for \"Gray\" | \"GrayOpaque\" | \"GrayFaint\"; splice it in with Graph[g, Sequence @@ AmbientGraphStyle[name]]. AmbientGraphStyle[] lists the names.";
